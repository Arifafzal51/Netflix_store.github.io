...
let increment = (id) => {
  ...
  if (search === undefined) {
    ...
    if(search.item>=5)
    alert('You can add upto 5 items per product');
    else
    search.item += 1;
  }
...
//  document.querySelector('#End').addEventListener("click",window.location.href="end.html");
// <button class="checkout"  onclick="location.href='end.html';">Checkout</button>
